...
const defaultContent = {
  ...
  projects: [
    ...
    },
    {
      ...
      title: 'Lake Valley Duplex City & Resort Limited',
      titleBn: 'লেক ভ্যালি ডুপ্লেক্স সিটি অ্যান্ড রিসোর্ট লিমিটেড',
      tagline: 'Premium Duplex Living & Luxury Suites',
      ...
      description: 'Lake Valley Duplex City & Resort Limited features premium two-story villas and resort suites within Lake Valley Flower City, combining spacious living, contemporary architecture, and proximity to the sports club, boarding school, convention hall, and community facilities.',
      image: 'https://lakevalleyflowercity.com/uploads/gallery-images/1785062826_00838.jpg',
      heroImage: 'https://lakevalleyflowercity.com/uploads/gallery-images/1785062826_00838.jpg',
      features: [
        'Two-story premium luxury villas',
      ...
      location: 'Within Lake Valley Flower City Master Plan, Dhaka',
      featured: true,
    },
    {
      ...
      title: 'Lake Valley Green Garden Resort',
      titleBn: 'লেক ভ্যালি গ্রীন গার্ডেন রিসোর্ট',
      tagline: 'Lakeside Hospitality & Serene Living',
      shortDescription: 'Lakeside resort destination with studio apartments, luxury villas, and world-class recreational facilities.',
      description: 'Lake Valley Green Garden Resort offers studio apartments, luxury holiday homes, and recreational spaces integrated into Lake Valley Flower City. Guests and owners enjoy lakeside dining, swimming pools, convention hall access, and organic garden views.',
      image: 'https://lakevalleyflowercity.com/uploads/gallery-images/1785062843_47538.jpg',
      heroImage: 'https://lakevalleyflowercity.com/uploads/gallery-images/1785062843_47538.jpg',
      features: [
        'Studio apartments & luxury lakeside suites',
        'Lakeside restaurant & fine dining experience',
        'State-of-the-art convention hall for events',
        'Infinity swimming pool & recreational club',
        'Surrounded by organic flower and botanical gardens',
        'Professional rental yield and management option',
      ],
      ...
      location: 'Resort Zone, Lake Valley Flower City, Dhaka',
      featured: true,
    },
    {
      ...
      title: 'Lake Valley Bangla Tower',
      titleBn: 'লেক ভ্যালি বাংলা টাওয়ার',
      tagline: 'Prime Commercial & Business Landmark',
      shortDescription: 'Modern commercial tower offering retail, office, and bank spaces near major industrial zones.',
      description: 'Lake Valley Bangla Tower is a high-yield commercial property situated strategically near BASIC Chemical Industrial City and Printing Industrial City. Features modern high-speed elevators, ample parking, 24/7 power backup, and high footfall location.',
      image: 'https://lakevalleyflowercity.com/uploads/pages/1784711067_90986.jpeg',
      heroImage: 'https://lakevalleyflowercity.com/uploads/pages/1784711067_90986.jpeg',
      features: [
        'Premium retail showrooms, bank booths & corporate offices',
        'High footfall commercial corridor',
        'High-speed modern elevators & 24/7 uninterrupted power',
        'Spacious underground & surface parking facilities',
        'High rental yield and capital appreciation potential',
        'Direct access to Dhaka-Mawa Expressway corridor',
      ],
      amenities: ['Elevators', 'Power Backup', 'Security', 'Parking', 'Fire Safety'],
      stats: { area: '15 Acres', plots: '80 Commercial Spaces', startingPriceUSD: 45000, pricePerKathaUSD: 15000 },
      location: 'Commercial Gateway — Main Entrance Boulevard',
      featured: true,
    },
  ],
  about: {
