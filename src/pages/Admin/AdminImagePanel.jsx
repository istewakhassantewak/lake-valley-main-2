        ...
        <div className="bg-white rounded-3xl p-6 md:p-8 border border-slate-200/80 shadow-sm flex flex-col md:flex-row md:items-center justify-between gap-6">
          <div>
            ...
            <div className="flex flex-wrap items-center gap-2 mt-2">
              ...
              <div className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full bg-slate-100 text-slate-700 text-xs font-medium">
                ...
                <span>Universal Admin Session Active</span>
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-wrap items-center gap-3">
            <Link
              ...
              className="px-4 py-2.5 rounded-xl bg-white border border-slate-200 text-slate-700 hover:bg-slate-50 hover:text-emerald-brand font-medium text-xs transition-all flex items-center gap-2 shadow-sm"
            >
              <Globe className="w-3.5 h-3.5 text-emerald-brand" /> View Live Site
            ...
            <button
              ...
              className="px-4 py-2.5 rounded-xl bg-white border border-slate-200 text-slate-700 hover:bg-slate-100 font-medium text-xs transition-all flex items-center gap-2 cursor-pointer shadow-sm"
            >
            ...
            <button
              ...
              className="px-4 py-2.5 rounded-xl bg-rose-50 border border-rose-200/80 text-rose-700 hover:bg-rose-100 hover:text-rose-800 font-semibold text-xs transition-all flex items-center gap-2 cursor-pointer shadow-sm"
              title="Lock Admin Panel & Sign Out"
            >
              <LogOut className="w-3.5 h-3.5 text-rose-600" /> Lock & Log Out
            </button>
          </div>
        </div>
